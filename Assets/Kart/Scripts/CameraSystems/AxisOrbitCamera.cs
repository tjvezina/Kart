...
namespace Modules.CameraSystems
{
    ...
    public class AxisOrbitCamera : OrbitCamera
    {
        ...
        {
            //NOTE: If hte camera rotation seems to be wigging out try adjusting hte Axes Dead and Sensitivity values. 0.1 and 1 respectively have worked well in the past
